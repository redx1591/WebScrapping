...
def scrapJumiaDeals(origin):
    ...
    for link in page:
        ...
        logo = 'http://137.74.199.121/img/logo/ma/jumiadeals.jpg'
        logoS = 'http://137.74.199.121/img/logo/ma/logoS/jumiadeals.jpg'
        ...
        for item in annonce:
            try:
                ...
                try:
                    prix = int(item.find_all("span", {"class": "price"})[0].text.strip().replace(u'MAD', '').replace(u'\xa0', ''))
                except:
                    prix=0
